...
function restart(elem) {
  ...
  initialNumberOfBalls = (initialNumberOfBalls<30) ? ++initialNumberOfBalls:30;
  document.getElementById("nbBalls").value =initialNumberOfBalls;
  init();
}